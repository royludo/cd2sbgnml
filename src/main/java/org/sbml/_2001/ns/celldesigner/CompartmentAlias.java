...
@XmlType(name = "compartmentAlias", propOrder = {"clazz", "bounds", "point",
  "namePoint", "doubleLine", "paint", "info"})
public class CompartmentAlias {
   ...
   * 
   * @return
   *         possible object is {@link DoubleLine }
   */
   ...
   * 
   * @param value
   *        allowed object is {@link DoubleLine }
   */
