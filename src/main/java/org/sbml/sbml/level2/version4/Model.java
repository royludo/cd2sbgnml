...
@XmlType(name = "Model", propOrder = {"annotation"})
public class Model extends OriginalModel {
   ...
   * 
   * @return
   *         possible object is {@link ModelAnnotationType }
   */
   ...
   * 
   * @param value
   *        allowed object is {@link ModelAnnotationType }
   */
