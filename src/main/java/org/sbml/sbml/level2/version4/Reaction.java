...
@XmlType(name = "Reaction", propOrder = {"annotation"})
public class Reaction extends OriginalReaction {
   ...
   * 
   * @return
   *         possible object is {@link ReactionAnnotationType }
   */
   ...
   * 
   * @param value
   *        allowed object is {@link ReactionAnnotationType }
   */
