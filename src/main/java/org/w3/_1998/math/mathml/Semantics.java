...
@XmlType(name = "Semantics", propOrder = {"apply", "cn", "ci", "csymbol",
  "_true", "_false", "notanumber", "pi", "infinity", "exponentiale",
  "semantics", "piecewise", "lambda", "annotationOrAnnotationXml"})
public class Semantics extends MathBase {
   ...
   * 
   * @return
   *         possible object is {@link Semantics }
   */
   ...
   * 
   * @param value
   *        allowed object is {@link Semantics }
   */
   ...
   * 
   * @return
   *         possible object is {@link Piecewise }
   */
   ...
   * 
   * @param value
   *        allowed object is {@link Piecewise }
   */
   ...
   * 
   * @return
   *         possible object is {@link Lambda }
   */
   ...
   * for the annotationOrAnnotationXml property.
   * <p>
