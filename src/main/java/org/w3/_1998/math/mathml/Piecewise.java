...
@XmlType(name = "Piecewise", propOrder = {"piece", "otherwise"})
public class Piecewise extends MathBase {
   ...
   * </pre>
   * <p>
   * Objects of the following type(s) are allowed in the list {@link Piece }
   *
   * @return the piece
   */
   ...
   * 
   * @return
   *         possible object is {@link Otherwise }
   */
